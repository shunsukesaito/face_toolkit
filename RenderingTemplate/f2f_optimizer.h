...
struct F2FParams
{
    ...
    std::vector<int> maxIter_ = {20, 20, 20};
    
    bool updateSH_ = false;
    bool useTex_ = false;
    bool useSeg_ = false;
    bool verbose_ = false;
    bool robust_ = false;
    bool with_exp_ = false;
    
    float gn_thresh_ = 1.e-6f; // gauss-newton threshold
    float mc_thresh_ = 4.0f; // mouth close threshold
    ...
    float w_landin_ = 8.e-3f;
    float w_landcont_ = 8.e-3f;
    float w_land3d_ = 100.f;
