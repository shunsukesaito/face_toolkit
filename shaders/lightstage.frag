...
void main(void)
{
	...
	****************************/
	if(u_use_pointlight != uint(0))
	{
		...
		float specscale = 1.0;
		float diffscale = 1.0;
		frag_spec = specscale * alpha_channel * specular_reflection * frag_spec_albedo;
        frag_spec.w = 1.0;
		frag_diff = diffscale * alpha_channel * frag_diff_albedo * diff_reflection;
        frag_diff.w = 1.0;
	...
	****************************/
	...
	{	
		...
		frag_spec = specscale * frag_spec_albedo * specular_reflection;
        frag_spec.w = 1.0;
		...
		frag_diff = diffscale * frag_diff_albedo * diff_reflection;
